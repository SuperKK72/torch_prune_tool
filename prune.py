...
if __name__ == '__main__':
    ...
    print('Suggested Gamma threshold should be less than %.4f'%highest_thre)
    print('The corresponding prune ratio is %.3f, but you can set higher.'%percent_limit)
    ...
    def prune_and_eval(model, sorted_bn, percent=.0):
        ...
        print('Gamma value that less than %.4f are set to zero!'%thre)
        ...
        print('Number of channels has been reduced from {} to {}'.format(len(sorted_bn),remain_num))
        print('Prune ratio: %.3f'%(1-remain_num/len(sorted_bn)))
        print("mAP of the 'pruned' model is %.4f"%mAP)
